...
# single thread 'mirror' mode web grab.

# accept these Special:xxxxxx pages !only! :
#
# http://cat.wiki.avid.com/index.php/Special:Lonelypages
# http://cat.wiki.avid.com/index.php/Special:Unusedimages
# http://cat.wiki.avid.com/index.php/Special:Allpages
# http://cat.wiki.avid.com/index.php?title=Special:Recentchanges&hideminor=0&hideliu=0&hidebots=0&hidepatrolled=0&limit=500&days=30&limit=500
#

#
# -fnrules:
#
# -fnrules F "*/index.php/*:*" "%h:%r/%d/%n%s.%X"     -- convert 'index.php/Images:xyz.png' HTML pages to 'index.php/Images:xyz.png.html'
# -fnrules F "*/index.php[/?]*" "%h:%r/%d/%b%s.%X"    -- convert 'index.php/YadaYada' HTML pages to 'index.php/YadaYada.html' 
# -fnrules F "*" "%h:%r/%d/%b%s.%Y"                   -- keep extensions on any other URL: favorite.ico, style.css, et al
#
