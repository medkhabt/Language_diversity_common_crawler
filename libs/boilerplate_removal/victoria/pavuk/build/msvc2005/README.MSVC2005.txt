...
installed, including Service Pack 1 (VS80sp1-KB926601).
...
In order to successfully compile pavuk on Win32 you need the following
source libraries:
...
The following directory layout for pavuk and the additional libraries is
...
has not been tested with the latest pavuk build(s).

[TODO: dirtree]


5.  Matching MSVC2005 project files for these libraries
-------------------------------------------------------

The libraries listed above do not come with suitable MSVC2005 project files,
but we provide these with pavuk for your convenience. Note that these
...
./build/msvc2005/extras/ directory.

[TODO: dirtree / file list?]



[Re]building pavuk on Win32 using MSVC2005/SP1
==============================================

Simply load the MSVC2005 solution file './build/msvc2005/pavuk.sln' and
choose 'Build' or 'Rebuild All', depending on your preference.

After a successful build you should have a fresh 'pavuk.exe' executable in
...
listed above. These are not mandatory for running pavuk.exe though (unless
...
You might want to read the man page before running pavuk. A few example
batch files (*.BAT) of pavuk use are included in the ./tests/ directory.
...
available, before asking your question in the pavuk mailing list. When you
...
line with a '[Win32-MSVC2005]' tag like this example:
  ...
  [Win32-MSVC2005] Has anyone successfully built pavuk with the MSVC2K5 Express edition?
