...
extern void html_parser_add_tag_func(html_parser_t *, html_parser_func_t, void *);
extern void html_parser_add_attrib_func(html_parser_t *, html_parser_func_t, void *);
extern void html_parser_add_style_func(html_parser_t *, html_parser_func_t, void *);
extern void html_parser_add_script_func(html_parser_t *, html_parser_func_t, void *);
...
extern void html_parser_parse_tag_slash_a(html_parser_t *, char *, html_extract_info_t *);
extern void html_parser_parse_tag_meta_refresh(html_parser_t *, char *, void *);
extern void html_parser_parse_tag_meta_robots(html_parser_t *, char *, html_robots_info_t *);
extern void html_parser_parse_tag_jstransform(html_parser_t *, char *, void *);
...
extern void html_parser_get_url(html_parser_t *, char *, html_extract_info_t *);
...
extern void html_parser_url_to_local(html_parser_t *, char *, html_rewrite_info_t *);
extern void html_parser_change_url(html_parser_t *, char *, html_change_info_t *);

extern void html_parser_get_style_urls(html_parser_t *, char *, html_extract_info_t *);
extern void html_parser_style_to_absolute_urls(html_parser_t *, char *, void *);
extern void html_parser_style_to_local_urls(html_parser_t *, char *, html_rewrite_info_t *);
extern void html_parser_style_change_url(html_parser_t *, char *, html_change_info_t *);

extern void html_parser_parse_jspatterns(html_parser_t *, char *, void *);
extern void html_parser_parse_body_jspatterns(html_parser_t *, char *, void *);
extern void html_parser_parse_body_jstransform(html_parser_t *, char *, void *);
