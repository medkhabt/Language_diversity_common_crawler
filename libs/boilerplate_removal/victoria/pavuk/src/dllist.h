...
extern dllist *dllist_new_entry(DBGdecl(dllist_t));
extern dllist *dllist_append(DBGdecl(dllist *), dllist_t);
#define dllist_append(l, e)             dllist_append(DBGvars(l), e)
...
extern dllist *dllist_remove_entry_custom(dllist * list, dllist * entry, dlfree_func free_func);
