...
extern char *_md5(void *);

extern int http_connect(char *, int);
extern int http_dummy_proxy_connect(doc *, char *, int, char *, int);
...
extern http_response *http_get_response_info(const char *);
extern int http_get_response_info2(http_response * dst, const char *doc_txt);
