...
void gkey_load(void)
{
  ...
  snprintf(pom, sizeof(pom), "%s%s%s", cfg.path_to_home, 
	  (tl_is_dirname(cfg.path_to_home) ? "" : "/"), PAVUK_GTK_KEYS_FILENAME);
  pom[sizeof(pom) - 1] = 0;
...
void gkey_save(void)
{
  ...
  if(!f)
  {
    xprintf(0, gettext("Unable to create ~/" PAVUK_GTK_KEYS_FILENAME " file\n"));
    return;
  }

  fprintf(f, gettext("# This file was generated by %s\n# You may edit it if you're careful!\n\n"), PACKAGE);
