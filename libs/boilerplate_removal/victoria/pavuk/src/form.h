...
extern char *form_decode_urlencoded_str(const char *, int);
extern char *form_encode_urlencoded_str(const char *);
...
extern char *form_encode_query(url *, form_info *, int *);

extern form_field *form_field_new(char *, char *);
extern form_field *form_field_duplicate(form_field *);
extern int form_field_compare(dllist_t key1, dllist_t key2);
extern int form_field_compare_name(dllist_t key1, dllist_t key2);
...
extern form_info *form_parse(char *, int, url_info * ui);
